...
from twisted.internet.error import TimeoutError, ConnectionRefusedError, ConnectError,DNSLookupError
from ele import fetch_free_proxyes
...
class HttpProxyMiddleware(object):
    ...
    DONT_RETRY_ERRORS = (TimeoutError, ConnectionRefusedError, ResponseNeverReceived, ConnectError, DNSLookupError, ValueError)
    ...
    def __init__(self, settings):
        ...
        # 存放代理列表的文件, 每行一个代理, 格式为http://ip:port 而且这个文件会被修改, 注意备份
    ...
    def fetch_new_proxyes(self):
        ...
        new_proxyes = fetch_free_proxyes.fetch_all(checked=True)
